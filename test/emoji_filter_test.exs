defmodule EmojiFilterTest do
  ...
  def remove_emoji(original_string) do
    original_string
    |> clean_newline_chars
    |> EmojiFilter.remove_emoji()
  end

  def remove_non_emoji(original_string) do
    original_string
    |> clean_newline_chars
    |> EmojiFilter.remove_non_emoji()
  end
  ...
  test "it can keep any emoji and remove plain text" do
    ...
    filtered_string = original_string |> remove_non_emoji
  ...
  test "flag emoji must be kept" do
    original_string = """
    ...
    🇦🇺🇨🇦🇨🇭🇨🇳🇩🇪🇪🇸🇫🇷🇬🇧🇮🇱🇮🇹
    🇯🇵🇰🇳🇰🇷🇳🇴🇳🇵🇵🇸🇶🇦🇷🇺🇸🇸🇺🇸
  ...
  test "apple emoji must be kept" do
    original_string = """
    ...
    🚗🚓🚨🚲🚡🚅🛶💺🚏🏦🕋🏦📱⌚️🖲🕯🔮🎎🎐💌📦
    📌☮️💟🔯☪️㊗️🈵🆚💯❕🔞🚷🔰⁉️⚠️💤🌐🌀▶️🔠🔣↔️↩️👁‍🗨
  ...
  test "keep fitzpatrick modifiers " do
    original_string = ".👦👦🏻👦🏼👦🏽👦🏾👦🏿👧👧🏻👧🏼👧🏽👧🏾👧🏿👨👨🏻👨🏼👨🏽👨🏾👨🏿👩👩🏻👩🏼👩🏽👩🏾👩🏿."
  ...
  test "pure text emoji must be kept" do
    original_string = """
    ...
    ㊗★☎☏♡♥♣♧☻☺♠♤▪▫
    ...
